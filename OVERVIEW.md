...
`tools/`) wrapped in an anchor to `wa.me`, which is WhatsApp's own
click-to-chat link: it hands off to the installed app where there is one and to
...
the end of the work and can say where the visitor has just been better than
they can.
